...
- `fb_post` = the TITLE only + newline + https://yallascore.site/a/<id>.html + newline + hashtags (#يلا_سكور + the clubs + the competition). No summary in the post (firm user rule).
